...
<body>
	<div class="container">
		...
		<div class="section">
			...
			<div class="grid">
				<a href="https://github.com/eogo-dev/eogo" target="_blank" class="card">
				...
				<div class="card">
					<div class="card-header">
						...
						<div class="card-content"><h2 class="card-title">CLI Tools</h2><p class="card-desc">Run <code>./eogo --help</code></p></div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="footer">
			...
			<div class="footer-links">
				<a href="https://github.com/eogo-dev/eogo" target="_blank">GitHub</a>
