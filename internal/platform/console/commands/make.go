...
func (c *MakeModuleCommand) Run(args []string) error {
	...
	data := map[string]string{
		...
		"PlatformPath":   "github.com/eogo-dev/eogo/internal/platform",
	}
...
func (h *{{.HandlerName}}Handler) List(c *gin.Context) {
...
func (h *{{.HandlerName}}Handler) Get(c *gin.Context) {
...
func (s *{{.SeederName}}Seeder) Run() error {
	db := database.GetDB()
